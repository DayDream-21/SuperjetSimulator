...
public class ElecGenRightOverload extends Malfunction {
    ...
    public void executeMalfunction() {
        ...
        Observable<MouseEvent> observableMain = JavaFxObservable.eventsOf(
                selectionPanelController.getFuelRightMAINButton(), MouseEvent.MOUSE_CLICKED
        );
                ...
                if (elecUnitsConnectionsController.isRightEngineConnected()) {
                    Platform.runLater(() -> {
                        if (selectionPanelController.isGalleyButtonSwitched()) {
                            ...
                            if (selectionPanelController.isFuelRightADDTButtonSwitched() && selectionPanelController.isFuelRightMAINButtonSwitched()) {
